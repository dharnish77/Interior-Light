...
// CODE BLOCK BEGIN On_Start RL_RR
// On start handler "RL_RR"
void on_start_RL_RR(void) { try { // on start event
 s32 FRD = 0;
s32 RLD = 0;
s32 interior = 0;
app.set_system_var_int32("R_L",1);//door open
app.set_system_var_int32("R_R",1);
app.get_system_var_int32("R_L",&FRD);
