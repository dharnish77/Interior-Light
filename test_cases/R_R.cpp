...
// CODE BLOCK BEGIN On_Start R_R
// On start handler "R_R"
void on_start_R_R(void) { try { // on start event
s32 FLD = 0;
s32 interior = 0;
app.set_system_var_int32("R_R",1);//door open
app.get_system_var_int32("R_R",&FLD);
