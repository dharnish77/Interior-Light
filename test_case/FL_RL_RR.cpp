...
// CODE BLOCK BEGIN On_Start FL_RL_RR
// On start handler "FL_RL_RR"
void on_start_FL_RL_RR(void) { try { // on start event
s32 FLD = 0;
s32 RLD =0;
s32 RRD = 0;
s32 interior = 0;
...
app.get_system_var_int32("F_R",&RLD);
app.get_system_var_int32("R_L",&RRD);
...
// CODE BLOCK END On_Start FL_RL_RR
